...
<link href="resources/css/togetherBoard/togetherBoardList.css?v=<%=System.currentTimeMillis()%>"rel="stylesheet">
<script>
...
<title>함께해요 메인페이지</title>
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-primary"
			...
			<div class="collapse navbar-collapse" id="t_navbar2">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item"><a class="nav-link" id="myLoc">내 위치)<span id="locMark"></span></a></li>
	...
	<!------- contents end --------->
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=a53c0b810ce1d051d15c474f3785be1d&libraries=services"></script>
<script src="resources/js/togetherBoard/togetherBoardList.js?v=<%=System.currentTimeMillis()%>"></script>