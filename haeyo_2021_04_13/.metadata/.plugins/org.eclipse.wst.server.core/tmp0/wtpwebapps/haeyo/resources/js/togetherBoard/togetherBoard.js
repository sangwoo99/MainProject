		...
		$.ajax({
			...
			success: function(result){
				...
				result="<tr id='trNo"+result.trNo+"'>"
					+"<td><img src='/resources/image/"+result.userVO.uPic+".jpg' height='50' width='50' style='border-radius:25px'></td>"
					+"<th>"+result.userVO.uNick+"</th>"
					+"<td>"+result.trContent+"</td>"
					+"<td>"+result.trCredate+"</td>"
					+"<td><button class='heayo_btn' onclick='editReply("+result.trNo+","+result.tNo+",\""+result.userVO.uPic+"\");'>수정</button></td>"
...
function editReply(trNo,tNo,uPic){
	...
	updateReplyInput = "<td><img src='/resources/image/"+uPic+".jpg' height='50' width='50' style='border-radius:25px'></td>"
					+"<th>"+uNick+"</th>"
					...
					+"<td><button class='heayo_btn' onclick='cancleReply("+trNo+","+tNo+",\""+trContent+"\",\""+uPic+"\");'>취소</button></a></td>";
...
function cancleReply(trNo,tNo,trContent,uPic){
	...
	updateReplyInput = "<td><img src='/resources/image/"+uPic+".jpg' height='50' width='50' style='border-radius:25px'></td>"
					...
					+"<td>"+trContent+"</td>"
					+"<td>"+trCredate+"</td>"
					+"<td><button class='heayo_btn' onclick='editReply("+trNo+","+tNo+",\""+uPic+ "\");'>수정</button></td>"
	...
	$.ajax({
		...
		success: function(result){
			...
			var	t_reply_content = "<tr id='trNo"+result.trNo+"'>"
				 ...
				 + "<td>"+result.trContent+"</td>"
				 + "<td>"+result.trCredate+"</td>"
				 + "<td><button class='heayo_btn' onclick='editReply("+trNo+","+result.tNo+",\""+result.userVO.uPic+"\");'>수정</button></td>"
				 + "<td><button class='heayo_btn' onclick='deleteReply("+trNo+");'>삭제</button></td>"
				 + "</tr>";
