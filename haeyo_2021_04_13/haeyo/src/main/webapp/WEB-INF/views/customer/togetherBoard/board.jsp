	...
	<div id="t_contents">
		...
		<div id="t_reply">
			...
			<table class="table" id="t_replyTable">
				<tr>
					<!-- 접속중인 user정보 가져와야함 -->
					<td><img id ="uPic" src='/resources/image/${userVO.uPic}.jpg'/></td>
					<th>${userVO.uNick}</th>
					<td>
						<form id="t_replyForm" method="GET" onSubmit="return false;">
							<input type="text" id="trContent" name="trContent"> 
				...
				<tr id="t_reply_content">
					<c:forEach var="Reply" items="${ReplyList}">
						<tr id="trNo${Reply.trNo}">
							<td><img id ="uPic" src='/resources/image/${Reply.userVO.uPic}.jpg'/></td>
							...
							<c:if test="${Reply.uNo == userVO.uNo}">
								<td><button class="heayo_btn"
										onclick="editReply(${Reply.trNo},${Reply.tNo},'${Reply.userVO.uPic}');">수정</button></td>
								<td><button class="heayo_btn" 
