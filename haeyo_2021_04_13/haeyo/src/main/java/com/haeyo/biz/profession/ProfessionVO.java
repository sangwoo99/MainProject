...
public class ProfessionVO {
	...
	public String toString() {
		return "ProfessionVO [pNo=" + pNo + ", uNo=" + uNo + ", pGender=" + pGender + ", pAddress=" + pAddress
				...
				+ ", pLiving=" + pLiving + ", pRefrigerator=" + pRefrigerator + ", pArrangement=" + pArrangement
				+ ", pHomein=" + pHomein + ", pWaterpipe=" + pWaterpipe + ", pElectric=" + pElectric + ", pDoor="
				+ pDoor + ", pTrash=" + pTrash + ", pTransportation=" + pTransportation + ", pOneroom=" + pOneroom
				+ ", pKeep=" + pKeep + "]";
	}
